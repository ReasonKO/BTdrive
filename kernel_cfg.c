/*
 *  kernel_cfg.c
 *  Thu Jul 11 12:21:54 2013
 *  SG Version 2.00
 *  sg.exe BTdrive2.oil -os=ECC2 -IC:/cygwin/nxtOSEK218/toppers_osek/sg/impl_oil -template=C:/cygwin/nxtOSEK218/toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType ReadBtPacket = 0;
const TaskType StatusMonitor = 1;
const TaskType Kicker = 2;
const TaskType Beeper = 3;

extern void TASKNAME( ReadBtPacket )( void );
extern void TASKNAME( StatusMonitor )( void );
extern void TASKNAME( Kicker )( void );
extern void TASKNAME( Beeper )( void );

static __STK_UNIT _stack_ReadBtPacket[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_StatusMonitor[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Kicker[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Beeper[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 3, TPRI_MINTASK + 10, TPRI_MINTASK + 1, TPRI_MINTASK + 1, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 3, TPRI_MINTASK + 10, TPRI_MINTASK + 1, TPRI_MINTASK + 1, };
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( ReadBtPacket ), TASKNAME( StatusMonitor ), TASKNAME( Kicker ), TASKNAME( Beeper ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_ReadBtPacket, (__STK_UNIT)_stack_StatusMonitor, (__STK_UNIT)_stack_Kicker, (__STK_UNIT)_stack_Beeper, };
...
const TickType alminib_almval[TNUM_ALARM] = { 1, 3, 1, 1, };
const TickType alminib_cycle[TNUM_ALARM] = { 10, 500, 100, 1000, };
